 ...
 *
 * A Handlebars Helper to help with rendering resource URLs in Mustache templates through Spring's
 * {@link org.springframework.web.servlet.resource.ResourceUrlProvider}.
 *
 * <p>Registered in {@link com.example.config.WebConfig} with the name "src" so that the following
 * template syntax will trigger its use: <pre class="code"> href="{{src "/css/main.css"}}" </pre>
 */
